...
// Task 4
// Давайте напишем функцию f4, 
// которая будет выводить массив a4 в out-4 при нажатии кнопки b-4. 
...
// Это не удобно. 
// Давайте напишем функцию f5, которая принимает массив как параметр и выводит его 
// в формате указанном в функции в указанный блок (как второй параметр).
...
// Функция должна получать из i-61 ключ, а из i-62 значение 
// и добавлять его в массив a6. После этого, с помощью функции f5 выводите массив 
// a6 в out-6.
...
// Функция должна получить значение из i-12 и удалить запись из массива a12 
// с таким значением. После этого вывести массив в out-12. 
...
// Функция должна в out-17 выводить элементы name вложенных массивов 
// в a17 для который age > 30. Вывод через пробел.
...
// Функция должна в out-20 вывести название станции которые содержат переход 
// на другую ветку. Такие станции маркируются 2. Вывод через пробел
