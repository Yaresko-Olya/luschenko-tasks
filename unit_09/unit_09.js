...
function f6() {
    ...
    let count = document.getElementsByClassName("p-6").length;
    out.innerHTML = count;
}
...
// По клику должна выполняться функция f9. Функция, должна добавлять класс .bg-orange тому .out-9 
// на котором кликнули.
...
// По клику должна выполняться функция f10. Функция, должна делать toggle класса .bg-orange 
// тому .out-10 на котором кликнули.
...
//  Task 11
// Кнопка .b-11, запускает функцию f11. Функция создает через createElement div c текстом 25 
...
function f12() {
    ...
    document.querySelector('.out-12').append(b);
}
...
function f13() {
    ...
    c.innerHTML = 'pushMe';
    c.classList.add('bg-orange');

    document.querySelector('.out-13').append(c);
    c.onclick = f13_1;
}
...
//  Task 14
// Кнопка .b-14, запускает функцию f14. Функция создает через createElement div c текстом 14 
// и добавляет ему класс .bg-orange. Созданный div добавляется в .out-14 с помощью append.


function f14() {
    let b = document.createElement('div');
    b.innerHTML = '14';
    b.classList.add('bg-orange');

    document.querySelector('.out-14').append(b);
}
...
function f15() {
    ...
    document.querySelector('.out-15').before(b);
}
...
function f16() {
    ...
    document.querySelector('.out-16').after(b);
}
...
function f17() {
    ...
    document.querySelector('.out-17').replaceWith(b);
}
...
function f18() {
    ...
    let classp18 = document.querySelector('.p-18')
    let data = classp18.getAttribute('data-b');
...
let classp19 = document.querySelectorAll('.p-19');

function f19() {
    let out = document.querySelector('.out-19');
    

    for (let i = 0; i < classp19.length; i++) {
        let data = classp19[i].getAttribute('data-b');
