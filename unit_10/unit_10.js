...
let ar1 = ['meh', 5, 10, true, false, 'move'];
...
let ar2 = ['meh', 5, 10, true, false, 'move'];
...
// массива (нуль, второй - и третий это индексы 0, 2, 3)
// Во всех задачах где говорим второй, третий и т.д. имеем ввиду индекс
...
// массива ar12 и выводит его в out-12. Разделитель - пробел. 
...
function f16() {
    ...
    out1.innerHTML = ar16_odd.join(' ');
    out2.innerHTML = ar16_even.join(' ');
}
