...
let par = document.querySelector('.p-3');
...
function f5() {
    ...
    const inpVal = input5.value

    if (input5.checked) {
        out5.innerHTML = inpVal;
    }
    else {
...
// Функция проверяет checked элемента .r-9. Если элемент выбран (checked) то выводит в .out-9 value radiobutton. 
...
function f10() {
    ...
    out10.style.backgroundColor = input10;
...
// Напишите код, который при изменении select .s-201 будет аналогично изменять выбранный option в .s-202.
