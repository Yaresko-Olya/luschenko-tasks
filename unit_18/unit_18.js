...
function t5(elem) {
    ...
    a5_res.push(elem.target.getAttribute('data'));
    document.querySelector('.out-5').innerHTML = a5_res;
    // let elemP = document.querySelectorAll('.task-5');

    // elemP.forEach(elem => a5_res.push(elem.getAttribute('data').onclick));
...
// Task 6 ============================================
/*  Дана строка str6='helloworld' - преобразуйте ее в массив и присвойте a6_res. Выведите на страницу. 
