...
let arrSet = new Set(a6);
const f6 = () => {

    document.querySelector('.out-6').innerHTML = arrSet.size;
 }
...
let result = 1;
    ...
    if (input.length !== p.size || input.length < 6) {
        result = '0';
    }
