...
Если все сделано верно, сервер пришлет строку hello. Не забывайте указывать параметр auth (ключ в чате). Выведите в out-10 результат. Запускаться функция должна по нажатию b-10.
*/
...
function t11() {
    ...
    xhttp.open("POST", "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=2&name=Olya", true);
    xhttp.send();
...
function t12() {
    ...
    xhttp.open("POST", "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=3&num1=5&num2=3", true);
    xhttp.send();
...
function t13() {
    ...
    xhttp.open("POST", "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=4&num1=5&num2=30", true);
    xhttp.send();
...
function t15() {
    ...
    xhttp.open("POST", "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=6&num1=2&num2=15", true);
    xhttp.send();
...
function t17() {
    ...
    xhttp.open("POST", "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=8&year=1997", true);
    xhttp.send();
...
function t18() {
    ...
    xhttp.open("POST", "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=9&m=1&d=1&y=1", true);
    xhttp.send();
