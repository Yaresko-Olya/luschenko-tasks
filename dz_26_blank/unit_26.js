...
function t4() {
    fetch (' http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=4&num1=3&num2=15')
    .then(data => {
        return data.text()
        .then(data => {
...
function t6() {
    fetch (' http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=6&num1=3&num2=20')
    .then(data => {
        return data.text()
        .then(data => {
...
function t12() {
    fetch (' http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=7859d9d42a8834141d529577207c9596&action=3&num1=8&num2=3',
    })
...
function t13() {
    fetch (' http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=7859d9d42a8834141d529577207c9596&action=4&num1=20&num2=100',
    })
...
// Task 15
/*Отправьте POST запрос (fetch) на сайт http://getpost.itgid.info/index2.php. В качестве action укажите 6.
Добавьте
параметр num1 и num2 содержащие числа. Если все сделано верно, сервер вернет большее число. Не забывайте
указывать параметр auth (ключ в чате). Выведите в out-15 результат. Запускаться функция должна по
нажатию b-15.*/
...
fetch (' http://getpost.itgid.info/index2.php', {
    ...
    body: 'auth=7859d9d42a8834141d529577207c9596&action=6&num1=20&num2=100',
})
