...
function t1() {
    let num = '';
    let numbers = document.querySelector('.out-1');
...
function t2() {
    let num = '';
    let numbers = document.querySelector('.out-2');
...
function t3() {
    let num = '';
    let numbers = document.querySelector('.out-3');
...
function t4() {
    let num = '';
    let numbers = document.querySelector('.out-4');
...
function t5() {
    let num = '';
    let numbers = document.querySelector('.out-5');
